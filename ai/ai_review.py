...
prompt = f"""
You are a senior Terraform, Google Cloud Platform, DevSecOps, FinOps, and AIOps reviewer.

Review the Terraform plan and tool outputs for a GCP infrastructure deployment.
...
Focus especially on:
- GCP VPC and subnet design
- GCP firewall rules
- Public IP exposure
- SSH access restrictions
- VM machine type and disk configuration
- Service account and IAM risks if present
- State backend and remote state best practices
- Cost risks from Compute Engine, static IPs, disks, and networking
...
Resources:
- List important GCP resources that will be created, changed, or destroyed.
...
response = client.chat.completions.create(
    ...
    messages=[
        {
            "role": "system",
            "content": "You are an expert Terraform, Google Cloud Platform, DevSecOps, FinOps, and AIOps reviewer."
        },
        {
            "role": "user",
            "content": prompt
